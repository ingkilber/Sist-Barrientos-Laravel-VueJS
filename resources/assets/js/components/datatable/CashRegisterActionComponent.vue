<template>
    <div class="action-button-wrapper">
        <div class='action-button-container'>
            ...
            <a href="" class='action-button' data-toggle="modal" data-target="#cash-register-add-edit-modal" @click.prevent="cashRegisterAddEdit(rowData.id)"><i class="la la-edit la-2x"></i></a>
        </div>
...
<script>
    export default {
        ...
        methods:{
            cashRegisterAddEdit(id)
            {
                this.$hub.$emit('cashRegisterAddEdit', id);
            },
