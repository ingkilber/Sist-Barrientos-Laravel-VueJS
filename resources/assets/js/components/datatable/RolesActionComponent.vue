<template>
    <div class="action-button-wrapper">
        <div class='action-button-container'>
            ...
            <a href="" class='action-button'  data-toggle="modal" data-target="#role-add-edit-modal" @click.prevent="roleAddEdit(rowData.id)"><i class="la la-edit la-2x"></i></a>
        </div>
...
<script>
    export default {
        ...
        methods:{
            roleAddEdit(id,title){
                this.$hub.$emit('roleAddEdit', id);
            },
